<template>
  <!--角色授权抽屉-->
  <b-drawer v-model="drawerVisible" :title="drawerTitle" :append-to-body="false" fullscreen class="layout-inner">
    <v-table-layout>
      <!--树结构-->
      ...
      <template slot="ctrl" v-if="canCreate">
        <b-button type="primary" v-waves size="small" @click="batchAuth"
