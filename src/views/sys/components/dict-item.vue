<template>
  <!--字典项抽屉-->
  <b-drawer v-model="dictItemVisible" :title="drawerTitle" :append-to-body="false" fullscreen
            class="layout-inner">
    <!--增加编辑区域-->
    <v-table-layout>
      <!--查询条件-->
      ...
      <!--编辑抽屉-->
      <b-modal v-model="dialogFormVisible" :title="editTitle" :mask-closable="false">
        <!--增加编辑区域-->
